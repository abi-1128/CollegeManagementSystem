...
<head>
	...
	<link rel="shortcut icon" href="C:\xampp\htdocs\College-Management-System\Images\imperial-banner.png" type="image/x-icon">
...
<nav class="navbar navbar-expand-lg navbar-dark header-back sticky-top header-navbar-fonts">
	<a class="navbar-brand d-flex align-items-center" href="index.php">
		<img src="C:\xampp\htdocs\College-Management-System\Images\imperial-banner.png" class="logo-image" width="50" height="50">
		<h3 class="text-light text-uppercase ml-2">DR.B.R.AMBEDHKAR.G.M.R.POLYTECHNIC, RAJAHMUNDRY</h3>
	</a>
